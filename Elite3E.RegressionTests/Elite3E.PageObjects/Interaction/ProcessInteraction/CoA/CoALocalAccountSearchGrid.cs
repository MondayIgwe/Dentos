...
{
    public class CoALocalAccountSearchGrid : IQuestion<string>
    {
        private CoALocalAccountSearchGrid()
        {
        }

        public static CoALocalAccountSearchGrid FirstRowNaturalValue() => new();
        ...
        public string RequestAs(IActor actor)
        {
            ...
            var taxOverride = new TaxOverrideEntity()
            {
                ...
                TaxAreaOverride = columns[2].Text
            };
