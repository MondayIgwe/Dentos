...
using Elite3E.RestServices.Services.VendorPayeeMaintenance;
...
{
    public class VendorPayeeMaintenanceTest
    {

        public IProcessService _process = new ProcessService();
        public ISessionService _session = new SessionService();
        public IVendorPayeeService _vendorPayeeService = new VendorPayeeService();
        public IRestResponse _response;
        public EntityData _entityData = new();


        [Test]
        public async Task CreateAVendorPayee()
        {
            ...
            //Get Process Item Id 
            _response = await _process.GetProcessItemIdAsync(sessionId, ApiConstants.VendorPayeeMaintenanceProcess);
            ...
            _response = await _process.AddNewProcessAsync(sessionId, processItemId, ApiConstants.VendorPayeeMaintenanceProcess);
            _response.IsSuccessful.Should().BeTrue();
            ...
            _response = await _vendorPayeeService.GetVendorPayeeEntitySearchList(sessionId, processItemId, vendor);
            _response.IsSuccessful.Should().BeTrue();
            ...
            _response = await _vendorPayeeService.AddVendorPayeeDataAsync(sessionId, processItemId, vendor);
            _response.IsSuccessful.Should().BeTrue();
            ...
            {
                Console.WriteLine("VendorPayee : " + vendor.EntityName);
