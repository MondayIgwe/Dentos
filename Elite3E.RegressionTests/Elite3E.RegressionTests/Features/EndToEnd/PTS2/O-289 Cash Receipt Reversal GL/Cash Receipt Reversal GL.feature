Feature: Cash Receipt Reversal GL

A requestor notifies a collector of misallocation and the collector requests for the receipt to be reversed and reallocated against a GL. 
The Cashier Team reviews the request, accept and reverses the receipt accordingly (Cash Receipt Use converted matter and bill).
Azure link: https://dev.azure.com/dentonsglobal/GFT%203E/_workitems/edit/41539
...
@e2eft
Examples:
	| OperatingUnit                  | ReceiptAmount | GLType             | GLAccount                              |
	| Dentons UK and Middle East LLP | 5000          | All Books GL Types | 3000-101010-1000-0000-0000-0000-000000 |
