Feature: Add New Cash Receipt

A client sends an EFT cash receipt to the Cashier Team however, 
the team cannot identify a relevant matter therefore the Cashier Team sends the cash back to the client.
Azure link: https://dev.azure.com/dentonsglobal/GFT%203E/_workitems/edit/41553
