@release7 @frd003 @DelegationRights_AddSome @ProxyTest
Feature: DelegationRights - Add Some
	Test 2: Delegation rights for one or a specified number of (but not all) workflows can be granted from one fee earner to another
...
Scenario: 010 Create update delegation rights task with one right
...
Examples:
	...
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | No                           | General Journal Approval | Dentons UK and Middle East LLP |
@europe
Examples:
	| DelegationUserWithRoles | DelegationUserWithoutRoles | DelegateAllWorkflowsCheckbox | WorkflowsToGrantAccessTo | DefaultOperatingAlias   |
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | No                           | General Journal Approval | Dentons Europe LLP (UK) |
@canada
Examples:
	| DelegationUserWithRoles | DelegationUserWithoutRoles | DelegateAllWorkflowsCheckbox | WorkflowsToGrantAccessTo | DefaultOperatingAlias |
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | No                           | General Journal Approval | Dentons Canada LLP    |

@singapore
Examples:
	| DelegationUserWithRoles | DelegationUserWithoutRoles | DelegateAllWorkflowsCheckbox | WorkflowsToGrantAccessTo | DefaultOperatingAlias        |
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | No                           | General Journal Approval | Dentons Rodyk & Davidson LLP |
...
Examples:
	...
	| FRD003_HasNoRoles          | General Journal Approval * |
...
Examples:
	...
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | false                        | Workflow Delegation Task | General Journal Approval  |
@qa
Examples:
	| DelegationUserWithRoles | DelegationUserWithoutRoles | DelegateAllWorkflowsCheckbox | NotificationTask   | WorkflowsToRevokeAccessTo |
	| FRD003_TwoRoles         | FRD003_HasNoRoles          | false                        | ML Delegation Task | General Journal Approval  |
