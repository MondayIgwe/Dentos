@release7 @frd009 @PropagationSetUpManagment
...
Scenario: 10 I want to propagate records
	...
	When I add a child three e instance
		...
		| <Process> | <Instance> | <ControlSource> |
	Then I want to 'include' items
	And I add another child three e instance
		| Process   | Instance   | ControlSource   |
		| <Process> | <Instance> | <ControlSource> |
	And I want to 'exclude' items
	Then I want to submit

@qa @uk @ft @training @staging @singapore
Examples:
...
Examples:
	| Process     | Instance                       | ControlSource  | Code           | Description     | InstanceType    | Region          | IsActive |
	| Region_Test | Canada User Acceptance Testing | Partial Global | TestAutomation | Test Automation | Test Automation | Test Automation | true     |
