...
Examples:
	...
	| Ann Smith | AnnSmith Client | Ann Smith     | Singapore | Miscellaneous | SG Output Domestic Zero | 500.00       | at_BOA_Group    | SGD - Singapore Dollar | Lara Moon | Dentons Rodyk & Davidson LLP |              |
@ft @pipelineTest
Examples:
	| User      | Client          | FeeEarnerName | Office         | ChargeType    | TaxCode                    | ChargeAmount | ChargeTypeGroup | Currency            | PayorName | DefaultOperatingAlias          | UserRoleList |
	| Ann Smith | AnnSmith Client | Ann Smith     | London (UKIME) | Miscellaneous | UK Output Domestic Zero 0% | 500.00       | at_BOA_Group    | GBP - British Pound | Lara Moon | Dentons UK and Middle East LLP |              |
@staging
Examples:
	| User      | Client          | FeeEarnerName | Office         | ChargeType    | TaxCode                     | ChargeAmount | ChargeTypeGroup | Currency            | PayorName | DefaultOperatingAlias          | UserRoleList                                                                |
	| Ann Smith | AnnSmith Client | Ann Smith     | London (UKIME) | Miscellaneous | UK Output Domestic Standard | 500.00       | at_BOA_Group    | GBP - British Pound | Lara Moon | Dentons UK and Middle East LLP | 0:AD:G:Common Authorisations,0:AD:G:System Administrator (read-only setups) |
...
Examples:
	...
	| Ann Smith     | Fixed-Capped Fees | 1     | test automation 1 | UK Output Domestic Zero 0% | GBP - British Pound |
@staging
Examples:
	| FeeEarnerName | TimeType          | Hours | Narrative         | TaxCode                     | Currency            |
	| Ann Smith     | Fixed-Capped Fees | 1     | test automation 1 | UK Output Domestic Standard | GBP - British Pound |
