...
Examples:
	| FeeEarnerName | User      | Client       | Unit | UnitDescription              | Currency               | CurrencyMethod | Office    | Department | Section | Rate     | ChargeTypeGroup | CostTypeGroup   | BillingOffice | PayorName |
	| Leo Peter     | Leo Peter | LeoPeter Ltd | 1201 | Dentons Rodyk & Davidson LLP | SGD - Singapore Dollar | Bill           | Singapore | Default    | Default | Standard | Auto_IncludeALL | Auto_IncludeALL | Milan         | James May |
