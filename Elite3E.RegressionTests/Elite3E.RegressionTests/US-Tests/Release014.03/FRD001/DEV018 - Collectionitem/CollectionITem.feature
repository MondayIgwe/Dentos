@us
#ignored because of this bug: https://dev.azure.com/dentonsglobal/GFT%203E/_workitems/edit/78480
...
Scenario Outline: 010 Verify that Quick Find operator for 'Payer Name' has been changed to 'Contains'
	...
	And I verify that the quick find include 'Contains With Related Client Number'
