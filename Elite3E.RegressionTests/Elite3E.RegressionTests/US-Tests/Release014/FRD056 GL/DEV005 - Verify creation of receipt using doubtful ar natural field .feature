...
Examples:
  ...
  | FRD56 Tom     | FRD56 Tom | FRD56 Client | USD - US Dollar | Bill           | Chicago | Default    | Default | Auto_IncludeALL | Auto_IncludeALL | Montreal      | James Matt | LAMMERS BARREL GROUP | USD                  | 1.00                     |
...
| NFCITIUSD  | 202060            | Dentons US, LLP |
