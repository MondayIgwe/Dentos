...
Examples:
	...
	| US Nominal Sequence | 8054-USNOM          | Client Billable     | Chicago | English (United Kingdom) | 8054-N-2020-000063 | 8054-N-2020-900001   | 8054-N-2020-000063   | 8054-N-2020-900001      |
...
Examples:
	| FeeEarnerName | User       | Client       | Currency        | CurrencyMethod | Office  | Department | Section | ChargeTypeGroup | CostTypeGroup   | BillingOffice | PayorName  | RemittanceAccount                                | PresentationCurrency | PresentationExchangeRate | InvoiceOverride     |
	| FRD36 Pete    | FRD36 Pete | FRD36 Client | USD - US Dollar | Bill           | Chicago | Default    | Default | Auto_IncludeALL | Auto_IncludeALL | Chicago       | James Matt | Dentons US, LLP - Application Off-Set Bank - USD | USD                  | 1.00                     | US Nominal Sequence |
