...
Examples:
	...
	| Cynthia Jose | Cynthia Client | Cynthia Jose  | Chicago | Miscellaneous | US Output Domestic Standard Rate | 500.00       | Desc_at_3e8glw7 | USD - US Dollar | Lara Moon |
...
Examples:
	...
	| Cynthia Jose  | FEES     | 1     | test automation 1 | US Output Domestic Standard Rate | USD - US Dollar |
